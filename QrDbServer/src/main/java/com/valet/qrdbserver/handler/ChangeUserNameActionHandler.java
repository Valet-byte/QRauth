...
@Component
@AllArgsConstructor
public class ChangeUserNameActionHandler implements ActionHandler {
    ...
    public boolean doAction(Action action) {
        ...
        try {
            ...
            query.addCriteria(Criteria.where("id").is(action.getUserId()));
            Update update = new Update();
            update.set("name", action.getValue());
    ...
    public ActionType getMyActionType() {
        return ActionType.CHANGE_USERNAME;
    }
}
